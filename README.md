...
The test suite includes 222 tests covering the HDF5 reader, metadata indexing, signal cache, resampling, statistics, trend analysis, correlation, and full integration tests against the Tornado server. All tests run without requiring real HDF5 data — a built-in mock provides realistic sample signals.
